...
class _$WalletImpl implements _Wallet {
  const _$WalletImpl(
      ...
      this.balance = 0.0,
      @JsonKey(name: 'currency') this.currency = 'ETB',
  ...
  @override
  String toString() {
    return 'Wallet(id: $id, userId: $userId, balance: $balance, currency: $currency, isActive: $isActive, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, userId, balance, currency, isActive, createdAt);
